...
namespace WinForms_Filmoteka
{
    public partial class MainForm : Form
    {
        ...
        private void ÔÓ‰≥ÎËÚËÒ¸œÂÂ„ÎˇÌÛÚËÏToolStripMenuItem_Click(object sender, EventArgs e)
        {
            SaveObjectToJson(seen);
        }

        private void ÔÓ‰≥ÎËÚËÒ¸¡‡Ê‡ÌËÏToolStripMenuItem_Click(object sender, EventArgs e)
        {
